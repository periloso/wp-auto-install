...
$wp = array(
	...
	'siteUrlBase'    => 'localhost/test/', // optional - it prepends before siteUrl
	'installDirBase' => 'd:\\www\\test\\', // optional - it prepends before installDir
...
$installator = array(
	...
	// 'gitExe'        => 'c:\tools\Git\bin\git.exe', // if you use Git instead of SVN
